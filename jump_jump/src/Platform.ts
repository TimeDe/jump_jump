...
declare interface Platform {
    ...
    sendMessage(code, info, isRight, finish?);
}
    ...
    sendMessage(code, info, isRight, finish = 1) {
        ...
        egret.ExternalInterface.call("sendToNative", JSON.stringify({
            ...
            data: {
                ...
                isRight: this.lastIsRight, //【0：错误，1：正确，2：未作答】
                answerTime: 0
            }
        }));
...
const CMD =  {
     //10001 载入游戏完成  10002答题 10003透传
    CODE : {
        INIT: 10001,
        ANSWER: 10002
    },
    //【0：错误，1：正确，2：未作答,3：作答完成】
    AnswerCode: {
        Invalid: -1,
        Wrong: 0,
        Right: 1,
    ...
    //0 结束 AI 课使用， 云教室 使用answerCode = 3 判度
    FinishCode: {
        Finish: 0,
        UnFinish: 1
    }
...
declare interface Window {
    ...
    platform: Platform
    __math2_res_config__: string  //cdn 地址
